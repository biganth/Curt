...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("A Profile Property with numbers at the start should work")]
        [NUnit.Framework.CategoryAttribute("ClearExtraProfileProperties")]
        [NUnit.Framework.CategoryAttribute("MustHaveAUserWithFullProfile")]
        public virtual void AProfilePropertyWithNumbersAtTheStartShouldWork()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("A Profile Property with numbers at the start should work", new string[] {
                        "ClearExtraProfileProperties",
                        "MustHaveAUserWithFullProfile"});
#line 118
this.ScenarioSetup(scenarioInfo);
...
#line 137
 testRunner.When("I have clicked on my name");
#line 138
    testRunner.Then("the Edit Profile link should be visible");
#line hidden
            this.ScenarioCleanup();
        }
    }
